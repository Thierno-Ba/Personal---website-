(function () {
  ...
  const translations = {
    en: {
      ...
      heroHeadline: 'Aspiring AI Professional Building Responsible Solutions for Real-World Challenges',
      ...
      skillsSubtitle: 'A blend of analytical rigor, business understanding, and growing technical capability — with a focus on connecting problems to practical solutions.',
      ...
      aboutLabel: 'About Me',
      aboutTitle: 'From Policy & Finance to AI & Impact',
      ...
      projectTitle: 'AI Mining Solutions for Guinea',
    ...
    fr: {
      ...
      heroHeadline: 'Professionnel IA en devenir, créant des solutions responsables pour des enjeux concrets',
      heroMission: 'Je suis diplômé en sciences politiques et finance et j\'approfondis mes compétences en IA via le programme Pursuit AI Native. J\'associe réflexion analytique, technologie et résolution de problèmes pour créer des solutions basées sur l\'IA qui améliorent la prise de décision, soutiennent les secteurs et ont un impact concret, y compris en explorant la contribution de l\'IA au secteur minier guinéen.',
      ...
      skillsSubtitle: 'Un mélange de rigueur analytique, de compréhension du monde des affaires et de capacités techniques en croissance — avec un souci de relier les problèmes à des solutions concrètes.',
      ...
      aboutTitle: 'De la politique et de la finance à l\'IA et à l\'impact',
      ...
      projectTitle: 'Solutions d\'IA pour le secteur minier guinéen',
